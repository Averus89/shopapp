...
public class ShopAppIntegrationTest {
    ...
    void tearDown() {
        ...
        Awaitility.await().atMost(Duration.of(2, ChronoUnit.SECONDS))
                .untilAsserted(() -> orderItemsRepository.findAll()
                        .as(StepVerifier::create)
                        .expectNextCount(0)
                        .verifyComplete()
                );
    ...
    void shouldApplyOrangeDiscountToOrder() {
        ...
        webTestClient.put()
                .uri("/orders/v1/add/101?productId=2&quantity=2")
                .exchange()
                .returnResult(Status.class)
                .getResponseBody()
                .as(StepVerifier::create)
        ...
        webTestClient.get()
                .uri("/orders/v1/getOrderSummary/101")
                .exchange()
                .returnResult(Order.class)
                .getResponseBody()
                .as(StepVerifier::create)
    ...
    void shouldReturnCorrectOrdersWithAppliedDiscounts() {
        ...
        webTestClient.put()
                .uri("/orders/v1/add/111?productId=1&quantity=2")
                .exchange()
                .returnResult(Status.class)
                .getResponseBody()
                .as(StepVerifier::create)
        ...
        webTestClient.put()
                .uri("/orders/v1/add/222?productId=2&quantity=2")
                .exchange()
                .returnResult(Status.class)
                .getResponseBody()
                .as(StepVerifier::create)
